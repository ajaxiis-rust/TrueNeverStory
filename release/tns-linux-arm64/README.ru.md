...
│   │   ├── agents/       # v0.25.0 новые агенты (Драматург, Валидатор, Стилист, Актёр, Цензор, Летописец)
│   │   └── ...
...
### v0.25.3 — Literary Compiler и экономические модели
...
### v0.25.0 — Архитектура State-First
