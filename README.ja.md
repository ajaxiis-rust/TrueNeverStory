# TrueNeverStory v0.10.0 – インタラクティブ・ナラティブ・ゲームプラットフォーム

**TrueNeverStory v0.10.0** は、[BRING](https://github.com/Eva-E1/BRING)ファンタジー世界プラットフォームの現代的な再実装で、Pythonから高性能ハイブリッドスタックに移行されました：
