# TrueNeverStory v0.11.0 – Платформа для создания интерактивных нарративных игр

**TrueNeverStory v0.11.0** – современная реализация платформы фэнтези-миров [BRING](https://github.com/Eva-E1/BRING), перенесённая с Python на высокопроизводительный гибридный стек:
