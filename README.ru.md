# TrueNeverStory v0.10.0 – Платформа для создания интерактивных нарративных игр

**TrueNeverStory v0.10.0** – современная реализация платформы фэнтези-миров [BRING](https://github.com/Eva-E1/BRING), перенесённая с Python на высокопроизводительный гибридный стек:
...
### Хранение в SQLite для промптов и переводов (v0.10.0)
...
### Новые специализированные агенты (v0.10.0)
...
### Система RAG для всех агентов (v0.10.0)
