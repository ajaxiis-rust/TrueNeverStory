...
│   │   ├── agents/       # v0.26.0 новые агенты (Драматург, Валидатор, Стилист, Актёр, Цензор, Летописец)
│   │   └── ...
...
### v0.26.0 — Literary Compiler и экономические модели
...
### v0.26.0 — Архитектура State-First
