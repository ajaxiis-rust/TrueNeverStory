# TrueNeverStory v0.14.1 – Платформа для создания интерактивных нарративных игр

**TrueNeverStory v0.14.1** – современная реализация платформы фэнтези-миров [BRING](https://github.com/Eva-E1/BRING), перенесённая с Python на высокопроизводительный гибридный стек:
