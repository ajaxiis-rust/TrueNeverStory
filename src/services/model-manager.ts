...
export const POPULAR_MODELS = [
  ...
  // ── Small / Creative LLMs (GGUF) ──
  { id: "creativewriter-llama3.2-3b-q4_k_m", name: "CreativeWriter Llama 3.2 3B (Q4_K_M)", size: "~1.9 GB", description: "theprint's creative-writing fine-tune of Llama 3.2 3B, tuned for prose & narrative", backend: "llamacpp" as const, url: "https://huggingface.co/theprint/CreativeWriter-Llama3.2-3B-GGUF/resolve/main/creativewriter-llama3.2-3b-q4_k_m.gguf" },
  { id: "llama3.2-3b-instruct-q4_k_m", name: "Llama 3.2 3B Instruct (Q4_K_M)", size: "~1.9 GB", description: "Meta's compact instruct model, balanced quality and speed", backend: "llamacpp" as const, url: "https://huggingface.co/unsloth/Llama-3.2-3B-Instruct-GGUF/resolve/main/Llama-3.2-3B-Instruct-Q4_K_M.gguf" },
  { id: "gemma-2-2b-it-q4_k_m", name: "Gemma 2 2B it (Q4_K_M)", size: "~1.6 GB", description: "Google's small instruct, strong quality for its size", backend: "llamacpp" as const, url: "https://huggingface.co/bartowski/gemma-2-2b-it-GGUF/resolve/main/gemma-2-2b-it-Q4_K_M.gguf" },
  { id: "qwen2.5-1.5b-instruct-q4_k_m", name: "Qwen 2.5 1.5B (Q4_K_M)", size: "~1.1 GB", description: "Alibaba's tiny multilingual (29+ languages), fast, low VRAM", backend: "llamacpp" as const, url: "https://huggingface.co/Qwen/Qwen2.5-1.5B-Instruct-GGUF/resolve/main/qwen2.5-1.5b-instruct-q4_k_m.gguf" },
  { id: "phi-3.5-mini-instruct-q4_k_m", name: "Phi-3.5 mini (Q4_K_M)", size: "~2.3 GB", description: "Microsoft's 3.8B mini, strong reasoning, 128k context", backend: "llamacpp" as const, url: "https://huggingface.co/bartowski/Phi-3.5-mini-instruct-GGUF/resolve/main/Phi-3.5-mini-instruct-Q4_K_M.gguf" },
  // ── Embedding Models ──
  ...
  { id: "nllb-200-distilled-600m-q8_0", name: "NLLB-200 600M (Q8_0)", size: "~620 MB", description: "Meta's 35+ language translation, fast & accurate — best for game translations", backend: "llamacpp" as const, url: "https://huggingface.co/nickypro/nllb-200-distilled-600M-GGUF/resolve/main/nllb-200-distilled-600M-Q8_0.gguf" },
  { id: "nllb-200-distilled-600m-q4_k_m", name: "NLLB-200 600M (Q4_K_M)", size: "~340 MB", description: "Meta's translation model, compact quantization, 35+ languages", backend: "llamacpp" as const, url: "https://huggingface.co/nickypro/nllb-200-distilled-600M-GGUF/resolve/main/nllb-200-distilled-600M-q4_k_m.gguf" },
  { id: "madlad400-3b-q4_k_m", name: "MADLAD-400 3B (Q4_K_M)", size: "~2 GB", description: "Google's 400+ language model, great for rare languages", backend: "llamacpp" as const, url: "https://huggingface.co/nickypro/madlad400-3b-GGUF/resolve/main/madlad400-3b-q4_k_m.gguf" },
];
