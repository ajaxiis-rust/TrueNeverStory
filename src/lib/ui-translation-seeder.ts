...
export function seedUITranslations(db: Database): void {
  const count = db.query('SELECT COUNT(*) as count FROM ui_translations').get() as { count: number };
