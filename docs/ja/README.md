...
│   │   ├── agents/       # v0.28.0 新エージェント (ドラマトゥルグ、バリデーター、スタイリスト、アクター、センサー、クロニクラー)
│   │   └── ...
...
完全なドキュメント：[DEV.README.md](DEV.README.md)
...
詳細は [COMPILE.md](../COMPILE.md) を参照。GitHub Actionsはタグプッシュ時に全プラットフォームを自動ビルドします。
...
### v0.28.0 — Literary Compiler と経済モデル
