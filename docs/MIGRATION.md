...
## v0.28.5 Migration: Literary Compiler & Economic Models

The v0.28.5 release adds the Literary Compiler and Economic Models. No migration required — these are additive features that extend the existing State-First pipeline.

## v0.28.5 Migration: State-First Pipeline

### What Changed

The v0.28.5 release introduces a state-first pipeline architecture that consolidates the previous 14-agent system into 6 specialized agents (The Big Six).
...
v0.28.5 introduces Model Context Protocol (MCP) tools for external knowledge access:
