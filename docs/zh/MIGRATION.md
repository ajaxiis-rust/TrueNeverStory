...
## v0.33.0 迁移：文学编译器与经济学模型

v0.33.0 版本新增了文学编译器与经济学模型。无需迁移 — 这些是扩展现有状态优先管道的附加功能。

## v0.33.0 迁移：状态优先管道

### 变更内容

v0.33.0 版本引入了状态优先的管道架构。两个代理系统现在共存：
...
v0.33.0 引入了 Model Context Protocol (MCP) 工具用于外部知识访问：
