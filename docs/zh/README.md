...
│   │   ├── agents/       # v0.27.0 新代理 (编剧、验证者、风格师、演员、审查员、编年史官)
│   │   └── ...
...
完整文档：[DEV.README.md](DEV.README.md)
...
详见 [COMPILE.md](../COMPILE.md)。GitHub Actions在标签推送时自动构建所有平台。
...
### v0.27.0 — Literary Compiler 和经济模型
