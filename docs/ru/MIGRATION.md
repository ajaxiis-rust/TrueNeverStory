...
## Миграция v0.33.0: Литературный компилятор и экономические модели

Релиз v0.33.0 добавляет Литературный компилятор и Экономические модели. Миграция не требуется — это аддитивные возможности, которые расширяют существующий конвейер State-First.

## Миграция v0.33.0: Конвейер State-First

### Что изменилось

Релиз v0.33.0 вводит архитектуру конвейера, ориентированного на состояние (state-first). Теперь сосуществуют две системы агентов:
...
v0.33.0 вводит инструменты Model Context Protocol (MCP) для доступа к внешним знаниям:
