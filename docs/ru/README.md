...
## Что нового в v0.29.7

### MCP Console — починка чекбоксов + авторизация
- **Чекбоксы книг** в каталоге теперь работают — выбор сохраняется после клика
- **Парольная защита** MCP-режима — тот же пароль, что и у основного сервера
- **[Руководство по MCP Console](MCP-HELP.md)** — полное руководство на 7 языках

### Веб-каталог — скачивание любимых авторов
Настраивайте весь MCP-пайплайн через браузер. Создайте персональную библиотеку из Project Gutenberg для улучшения стиля нарратива:
1. Введите имена авторов (Mark Twain, Jack London, Edgar Allan Poe...) или темы
2. Просматривайте, ищите и фильтруйте каталог
3. Выбирайте книги чекбоксами
4. Скачивайте и позвольте агенту-стилисту учиться у выбранных авторов

Подробности — в **[Руководстве по MCP Console](MCP-HELP.md)**.
