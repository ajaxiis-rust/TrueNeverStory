# TrueNeverStory v0.33.4 — Руководство по компиляции
...
### Веб-каталог Gutenberg

Через MCP Console (`/mcp.html`) можно скачивать любимых авторов из Project Gutenberg для улучшения стиля письма:

1. Откройте вкладку «Каталог»
2. Введите имена авторов или тему
3. Просмотрите, отфильтруйте и выберите книги
4. Скачайте — стили автоматически извлечены для агента-стилиста

Подробнее — **[Руководство по MCP Console](MCP-HELP.md)** (7 языков).
...
│   ├── libtns_vector_full.so   # Mojo: полноразмерные векторные операции
