...
## Migración v0.33.4: Compilador Literario y Modelos Económicos

La versión v0.33.4 añade el Compilador Literario y los Modelos Económicos. No se requiere migración — son funcionalidades aditivas que extienden el pipeline State-First existente.

## Migración v0.33.4: Pipeline State-First

### Qué cambió

La versión v0.33.4 introduce una arquitectura de pipeline state-first. Ahora coexisten dos sistemas de agentes:
...
v0.33.4 introduce herramientas del Model Context Protocol (MCP) para el acceso a conocimiento externo:
