# Agents Reference (v0.28.5)

TrueNeverStory uses a multi-agent architecture where each agent handles a specific aspect of the narrative. As of v0.28.5, the engine uses **6 core agents** (The Big Six) plus **5 specialist agents** and a **dialogue system**.
...
The following agents are deprecated in v0.28.5 but still available for backward compatibility:
