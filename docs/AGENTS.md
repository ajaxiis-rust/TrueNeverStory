# Agents Reference (v0.29.0)

TrueNeverStory uses a multi-agent architecture where each agent handles a specific aspect of the narrative. As of v0.29.0, the engine uses **6 core agents** (The Big Six) plus **5 specialist agents** and a **dialogue system**.
...
The following agents are deprecated in v0.29.0 but still available for backward compatibility:
